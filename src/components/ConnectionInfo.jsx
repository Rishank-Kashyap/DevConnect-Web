...
const ConnectionInfo = () => {
  ...
  const { selectedConnection } = useSelector((store) => store.connections);
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-pink-50 flex flex-col items-center justify-center p-8">
        <div className="text-center max-w-md">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">
            🕵️ No Connection Selected
          </h1>
          <p className="text-gray-600 text-lg mb-6">
            Please select a connection from your network to view their profile
          </p>
          <button
